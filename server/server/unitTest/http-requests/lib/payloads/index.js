...
function Payloads() {
  ...
  return Object.assign({
    ...
    getStatusUpdate(entity) {
      return payload[`getStatusUpdate${entity.constructor.name}`].apply(null, [entity])
    },
    getUpdateBody(entity) {
      return payload[`getUpdate${entity.constructor.name}`].apply(null, [entity])
    }
  }, payload);
}
